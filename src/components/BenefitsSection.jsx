    ...
    return (
        <div className="">
            <div className="flex justify-center items-center h-[166px]">
                <h1 className='text-gold text-[36px] font-semibold'>Our Benefits</h1>
            </div>
            <div className="w-full h-[520px] bg-[#EFD9D8]">
                <div className="flex flex-row px-8 gap-16 text-[22px] h-[100px] justify-center items-center text-primary font-medium">
                    <button
                    ...
                    <div className=''>
                        <div className="flex justify-center">
                            <div className="flex items-center gap-[80px]">
                                ...
                                <div className="h-[270px] bg-gold w-[2px]"></div>
                            </div>
